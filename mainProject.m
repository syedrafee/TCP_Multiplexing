...
while(t<100) %Infinite loop
   ...
   if(bufferSize<0)%If the buffer is less than zero - packet loss has occured   
    ...
    bufferSize2=bufferSizeTotal-c(1)+1;%use the location of the first zero to calculate the buff
